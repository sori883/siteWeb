...
import { FetchImagesList, ImagesList } from 'types/image/imageLibrary';
import {
  ImageInput,
  SelectImages
} from 'types/selector/imageSelector';

const LIMIT = 15;

// アイキャッチセレクター
export const useSelectImages = (config: SWRConfiguration, id: number | null): SelectImages => {
